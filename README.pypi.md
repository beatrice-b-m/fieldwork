...
![A map of a laboratory table: participants connect to specimens, instruments and assays connect to runs, and the branches meet at specimen measurements](https://raw.githubusercontent.com/beatrice-b-m/fieldwork/v0.1.0/docs/assets/wide-table.png)

That gives you a starting point for deciding how to group the data, what to count,
and which records deserve a closer look.
[Try the laboratory example](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.0/examples/wide_table.py) to build this map yourself
from synthetic data.
...
[guided notebook](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.0/examples/investigation.ipynb). The
...
For contributing and local setup, see the [developer documentation](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.0/docs/index.md).
Fieldwork is [MIT licensed](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.0/LICENSE); see [NOTICE](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.0/NOTICE) for project provenance.
