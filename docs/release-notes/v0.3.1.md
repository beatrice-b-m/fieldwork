...
Fieldwork 0.3.1 is a small maintenance release that fixes two presentation bugs
in 0.3.0. Analyses, saved-result formats and the public API are unchanged from
0.3.0. Python 3.11–3.14 remains supported; pandas and NumPy remain the only
