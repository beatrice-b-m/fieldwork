...
![A map of a laboratory table: participants connect to specimens, instruments and assays connect to runs, and the branches meet at specimen measurements](https://raw.githubusercontent.com/beatrice-b-m/fieldwork/v0.1.1/docs/assets/wide-table.png)

That gives you a starting point for deciding how to group the data, what to count,
and which records deserve a closer look.
[Try the laboratory example](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.1/examples/wide_table.py) to build this map yourself
from synthetic data.
...
[guided notebook](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.1/examples/investigation.ipynb). The
...
See the [0.1.1 release notes](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.1/docs/release-notes/v0.1.1.md) for progress controls,
work budgets, compact exports, and dependency coverage and repeated support.

For contributing and local setup, see the [developer documentation](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.1/docs/index.md).
Fieldwork is [MIT licensed](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.1/LICENSE); see [NOTICE](https://github.com/beatrice-b-m/fieldwork/blob/v0.1.1/NOTICE) for project provenance.
